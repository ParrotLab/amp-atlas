...
const api = {
  ...
  git: {
    ...
    convertPrToDraft: (repoPath: string, num: number) => ipcRenderer.invoke('git:convertPrToDraft', repoPath, num),
    markPrReady: (repoPath: string, num: number) => ipcRenderer.invoke('git:markPrReady', repoPath, num),
    ...
    reviewRequestCount: (repoPath: string, login: string) => ipcRenderer.invoke('git:reviewRequestCount', repoPath, login),
